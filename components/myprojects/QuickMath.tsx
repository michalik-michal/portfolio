...
export default function QuickMath() {
  return (
    <div className="bg-black h-auto flex flex-col sm:h-5/6 pt-48">
      <div className="flex flex-col-reverse sm:flex-row justify-center">
        ...
        <div className="pl-12 px-8">
          <div className="pr-12 flex row">
            ...
            <a
              href="https://apps.apple.com/pl/app/quick-mathematics/id1621110947"
              target={"_blank"}
            ...
            <a
              href="https://github.com/michalik-michal/QuickMath"
              target="_blank"
              className="pt-1 pl-4"
            >
              {" "}
