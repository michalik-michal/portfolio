                    ...
                    <div className="flex flex-row justify-center">
                        <div className="pl-12">
                            <div className="flex flex-row pb-5">
                                ...
                                <h1 className="text-5xl font-bold pl-4 pt-4 "> Michal Michalik </h1>
                            </div>
                            <h2 className="text-3xl w-[40rem] leading-relaxed pb-5"> I am an ex athlete. I was a long time member of the Polish Alpine Skiing National Team. I started coding around 2020 and I quit professional sport in the beggining of 2022 to start working as software engeneer.</h2>
                            <a href={gallupLink} target="_blank" className="text-xl bg-gray-500 p-4 rounded-md hover:font-semibold"> See My Clifton Strengths Test ✏️ </a>
                        </div>
                    </div>
                </div>
            </div>
